...
from api_fhir_r4.permissions import FHIRApiInsureePermissions, FHIRApiGroupPermissions, FHIRApiInvoicePermissions, \
    FHIRApiHealthServicePermissions, FHIRApiPractitionerPermissions, FHIRApiCoverageRequestPermissions, FHIRApiMedicationPermissions, FHIRApiActivityDefinitionPermissions, FHIRApiClaimPermissions
...
class SubscriptionSerializer(BaseFHIRSerializer):
    ...
    resource_permissions = {
        ...
        'practitioner': FHIRApiPractitionerPermissions.permissions_get
