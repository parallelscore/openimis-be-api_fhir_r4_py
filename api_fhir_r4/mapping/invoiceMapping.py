...
class BillChargeItemMapping(object):
    ...
    charge_item = {
        ...
        "capitationpayment": {
            # TODO This charge item type is missing in the profile, but is generated by Capitation calculation rule. this is left in the mapping to not break the conversion
            "code": "capitation",
            "display": "Capitation",
            "system": SYSTEM
        },
