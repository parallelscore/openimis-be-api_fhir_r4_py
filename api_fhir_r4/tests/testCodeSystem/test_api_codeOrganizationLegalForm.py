...
class CodeSystemOrganizationLegalFormAPITests(GenericFhirAPITestMixin, APITestCase):
    ...
    base_url = GeneralConfiguration.get_base_url()+'CodeSystem/organization-legal-form/'
    ...
    def test_get_should_return_code_system(self):
        ...
        self.assertEqual(response_data['name'], 'openIMISOrganizationLegalForm')
        self.assertEqual(response_data['title'], 'openIMIS Organization Legal Form')
