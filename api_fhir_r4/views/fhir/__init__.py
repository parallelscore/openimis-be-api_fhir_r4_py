...
from api_fhir_r4.views.fhir.code_systems.patient_identification_type import CodeSystemOpenIMISPatientIdentificationTypeViewSet
...
from api_fhir_r4.views.fhir.code_systems.organization_legal_form import CodeSystemOpenIMISOrganizationLegalFormViewSet
